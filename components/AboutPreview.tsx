...
export default function AboutPreview() {
  return (
    <section className="mt-12 grid gap-8 border border-[#D8C6B6] bg-white px-8 py-10 shadow-[0_8px_24px_rgba(0,0,0,0.05)] md:grid-cols-[3fr_2fr]">
      <div>
        ...
        <Link
          href="/about"
          className="mt-6 inline-flex items-center gap-2 rounded-[6px] border border-[#2C2C2C] px-5 py-2 text-[11px] font-semibold uppercase tracking-[0.25em] text-[#2C2C2C] transition hover:bg-[#2C2C2C]/10 focus:outline-none focus:ring-1 focus:ring-[#2C2C2C]"
        >
          Citește povestea
        </Link>
      </div>
      <div className="relative aspect-[4/5] w-full overflow-hidden border border-[#D8C6B6] bg-[#F6F2EE]">
        <Image
