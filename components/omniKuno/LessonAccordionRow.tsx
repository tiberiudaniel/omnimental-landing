  ...
  return (
    <div className="w-full">
      <button
        ...
        className={cn(
          "flex w-full items-center justify-between rounded-card border px-4 py-3 text-left transition-all md:px-5 md:py-4",
      ...
      {isOpen && status === "active" ? (
        <div className="mt-3 rounded-card border border-[#F2B39B]/60 bg-[var(--omni-surface-card)] p-4 md:p-5">{children}</div>
      ) : null}
    </div>
  );
}
