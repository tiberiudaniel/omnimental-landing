...
export function MissionMentalProgressView({ missionTitle, mental = [], onNextStep }: MissionMentalProgressViewProps) {
  ...
  return (
    <section className="grid gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
      <div className="relative flex w-full items-center justify-center overflow-hidden rounded-3xl border border-[var(--omni-border-soft)] bg-[var(--omni-surface-card)]/90 p-4 shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
        <Image
