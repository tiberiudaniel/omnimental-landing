# decision_discernment_arc_01_trezire
[SCREEN arcIntro]
title: Trezirea
...
# decision_discernment_arc_02_primele_ciocniri
[SCREEN arcIntro]
...
# decision_discernment_arc_03_profunzime
[SCREEN arcIntro]
title: Profunzime
...
# decision_discernment_arc_04_maestrie
[SCREEN arcIntro]
title: Maestrie
...
body: Acest test scurt îți arată ce ai integrat despre diferența dintre impuls și decizie, criterii, risc, valori, incertitudine și ritualuri de decizie.
...
- O decizie luată cu o mică pauză, în acord cu valorile tale și cu riscurile înțelese.
- O decizie luată doar ca să scapi de disconfort.
correctIndex: 1

[TEST question]
type: scenario
question: Ai o decizie importantă și te simți blocat de frica de a greși. Ce este aliniat cu modulul?
options:
- Amâni la nesfârșit până când dispare orice urmă de frică.
- Numești riscul principal, stabilești un criteriu și iei o decizie „suficient de bună” pentru următorul pas.
- Alegi la întâmplare ca să se termine.
correctIndex: 1

[TEST question]
type: singleChoice
question: Ce ajută cel mai mult în clarificarea deciziilor?
options:
...
[TEST question]
type: singleChoice
question: Când este cel mai potrivit să iei o decizie importantă?
options:
- Când ești flămând(ă), epuizat(ă) și foarte tensionat(ă), ca să „scape odată”.
- Când corpul este într-o stare relativ stabilă (măcar puțin hrană, apă, o scurtă pauză de respirație), iar tu ai clarificat ce vrei și care este riscul principal.
- Când ești complet disociat(ă) de ce simți în corp.
correctIndex: 1
