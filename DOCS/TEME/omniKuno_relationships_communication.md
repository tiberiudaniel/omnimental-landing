# relationships_communication_arc_01_trezire
[SCREEN arcIntro]
title: Trezirea
...
# relationships_communication_arc_02_primele_ciocniri
[SCREEN arcIntro]
...
# relationships_communication_arc_03_profunzime
[SCREEN arcIntro]
title: Profunzime
...
# relationships_communication_arc_04_maestrie
[SCREEN arcIntro]
title: Maestrie
...
body: Un test scurt pentru a verifica ce ai integrat despre ascultare, limite și reparații rapide. Nu există note, doar claritate.
...
[TEST question]
type: scenario
question: Partenerul ridică tonul și îți spune că îl ignori. Ce răspuns e aliniat cu modulul Relații și Comunicare?
options:
- Răspunzi cu același ton și îi amintești toate greșelile lui.
- Spui că exagerează și te retragi din conversație.
- Respiri, reflectezi ce ai auzit („Sună ca și cum te simți ignorat.”) și propui o limită calmă.
correctIndex: 2
...
- accept și ce nu mai pot accepta
...
[TEST question]
type: scenario
question: Ești foarte flămând(ă) și obosit(ă), iar cineva apropiat îți spune ceva care te irită. Ce este aliniat cu ceea ce ai învățat în modul?
options:
- Răspunzi imediat, pe un ton tăios, ca să „spui ce ai pe suflet”.
- Observi că ești înfometat(ă) și tensionat(ă), îți iei un minut să te reglezi (apă, respirație) și apoi revii la discuție.
- Eviți pentru totdeauna orice discuție atunci când ești obosit(ă).
correctIndex: 1
