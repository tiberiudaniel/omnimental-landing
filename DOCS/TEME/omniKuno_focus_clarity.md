...
# focus_clarity_arc_02_primele_ciocniri
...
# focus_clarity_arc_03_profunzime
...
[TEST question]
type: singleChoice
question: Ce descrie cel mai bine claritatea, așa cum ai lucrat în acest modul?
options:
...
- Să începi să lucrezi la toate sarcinile în paralel.
correctIndex: 1

[TEST question]
type: scenario
question: Ai cinci lucruri de făcut și te simți copleșit. Ce acțiune este cea mai aliniată cu modulul de Claritate și Focus?
options:
- Să alegi un singur lucru ca prioritate și să aplici un protocol simplu (opresc, aleg, respir, pas mic).
- Să te apuci de toate puțin, fără să le clarifici.
- Să amâni totul și să ignori situația.
correctIndex: 0

[TEST question]
type: fillBlank
question: Completează propoziția: „O prioritate este ___.”
...
[TEST question]
type: singleChoice
question: Ce condiție sprijină cel mai bine claritatea mentală?
options:
- Să sari peste mese și să ignori oboseala.
- Un corp relativ stabil: hrană decentă, hidratare, respirație mai lentă.
- Să stai nemișcat(ă) și să speri că „vine” focusul.
correctIndex: 1
