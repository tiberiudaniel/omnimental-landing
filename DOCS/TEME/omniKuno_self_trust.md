...
# self_trust_arc_02_primele_ciocniri
[SCREEN arcIntro]
...
body: Acest test scurt îți arată ce ai integrat despre promisiuni realiste, voce interioară, limite, reparație și ritualuri de încredere în tine.
...
- Să te poți baza pe tine că vei duce la capăt suficiente promisiuni realiste.
- Să pari mereu sigur(ă) pe tine în fața altora.
correctIndex: 1

[TEST question]
type: scenario
question: Ți-ai promis că lucrezi 30 de minute la un proiect personal și nu ai făcut nimic azi. Ce este aliniat cu modulul?
options:
- Te insulți în minte și decizi că „nu are rost”.
- Spui: „Nu am reușit azi, înțeleg de ce, reduc promisiunea la 10 minute mâine și o trec în calendar.”
- Ignori complet situația.
correctIndex: 1

[TEST question]
type: singleChoice
question: Ce ajută cel mai mult reconstruirea încrederii în tine după o perioadă cu multe promisiuni încălcate?
options:
...
variations:
- realiste si respectate
- realiste si mai des respectate
...
[TEST question]
type: scenario
question: Ți-ai propus să lucrezi seara la un obiectiv personal, dar ajungi acasă epuizat(ă) și nu ai mâncat de ore bune. Ce abordare sprijină încrederea în tine?
options:
- Te forțezi cu orice preț și, dacă nu reușești, te insulți în gând.
- Observi că ești foarte jos ca energie, mănânci ceva, reduci promisiunea la un pas mic realist pentru seara asta sau o reprogramezi clar pentru mâine.
- Renunți complet la obiectiv, spunând că „nu ești în stare de nimic”.
correctIndex: 1
