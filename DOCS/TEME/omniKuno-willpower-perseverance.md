# willpower_perseverance_arc_01_trezire
[SCREEN arcIntro]
title: Trezirea
...
# willpower_perseverance_arc_02_primele_ciocniri
[SCREEN arcIntro]
...
# willpower_perseverance_arc_03_profunzime
[SCREEN arcIntro]
title: Profunzime
...
# willpower_perseverance_arc_04_maestrie
[SCREEN arcIntro]
title: Maestrie
...
body: Acest test scurt verifică ce ai integrat despre voință ca resursă, pași mici, prioritizare, fricțiune și consecvență.

[TEST question]
type: singleChoice
question: Ce descrie corect voința?
options:
- Este o energie finită.
- Este infinită.
correctIndex: 0

[TEST question]
type: scenario
question: Încerci să începi 4 obiceiuri noi în aceeași săptămână. Ce este aliniat cu modulul?
options:
- Continui așa, e doar o chestiune de disciplină.
- Aleg un singur obicei principal și reduc restul.
- Le abandonezi pe toate.
correctIndex: 1

[TEST question]
type: singleChoice
question: Care este cel mai sigur tip de start?
options:
- Intens și mare.
- Mic și repetabil.
correctIndex: 1
