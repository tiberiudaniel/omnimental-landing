...
# energy_body_arc_02_primele_ciocniri
[SCREEN arcIntro]
...
body: Acest test scurt îți arată ce ai integrat despre semnalele corpului, ritm, respirație, somn și reparație după efort.

[TEST question]
type: singleChoice
question: Ce este cel mai sănătos mod de a privi semnalele corpului?
options:
- Ca pe defecte care trebuie ignorate.
...
[TEST question]
type: scenario
question: Ai lucrat intens multe ore, te simți gol de energie și începi să greșești des. Ce acțiune este aliniată cu modulul?
options:
...
[TEST question]
type: singleChoice
question: Ce ajută cel mai mult un somn mai bun?
options:
- Să adormi mereu cu ecranul în față.
- Un ritual simplu și repetat care îți liniștește mintea și corpul.
- Să schimbi ora de culcare constant, după cum se nimerește.
correctIndex: 1
...
prompt: „Un lucru concret pe care vreau să îl fac în următoarele 24 de ore pentru a-mi proteja energia este ___.”

[TEST question]
type: singleChoice
question: Ce este adevărat despre relația dintre intestin și stare psihică?
options:
- Intestinul nu influențează deloc energia sau dispoziția.
- Intestinul și flora sa influențează energia, emoțiile și claritatea mentală.
- Doar cafeaua decide câtă energie ai, restul nu contează.
correctIndex: 1
